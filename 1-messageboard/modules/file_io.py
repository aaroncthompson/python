def load_file():
    ...
    try:
        with open('messageboard.txt') as messageboard_file:
            messages = messageboard_file.read()
...
def write_file():
    ...
    with open('messageboard.txt', 'a') as messageboard_file_write:
        messageboard_file_write.write(messages)
